//  FollowerList+CoreDataClass.swift
//  RavindraBhatiTest
...
@objc(FollowerList)
public class FollowerList: NSManagedObject, Codable {
    ...
    required convenience public init(from decoder: Decoder) throws {
        guard let contextUserInfoKey = CodingUserInfoKey.context,
            ...
            let entity = NSEntityDescription.entity(forEntityName: "FollowerList", in: managedObjectContext)
            else {
        ...
        do {
            ...
            print ("FollowerList  Decoding error")
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        do {
            ...
            print("FollowerList  Encoding error")
        }
    }
